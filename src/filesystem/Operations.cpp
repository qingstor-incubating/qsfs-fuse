...
// Get the file
//
// @param  : path, force update node, flag update dir, flag update dir asynchronously
...
//
// Note: If forceUpdateNode or time is expired, GetFile will connect to object storage
